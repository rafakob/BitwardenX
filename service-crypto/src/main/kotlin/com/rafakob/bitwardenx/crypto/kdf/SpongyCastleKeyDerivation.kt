...
internal class SpongyCastleKeyDerivation : KeyDerivation {
    ...
    override fun deriveKey(password: ByteArray, salt: String, type: KdfType, iterations: Int): ByteArray {
        val generator = createGenerator(type)
        generator.init(password, salt.toByteArray(Charsets.UTF_8), iterations)
